...
#include <csp/interfaces/csp_if_ewc.h>
#include <csp/interfaces/csp_if_ms200.h>
#if (CSP_WINDOWS)
#include <Windows.h>
#endif
...
/**
   Opens UART device and add CCSDS interface.
   ...
   @return #CSP_ERR_NONE on success, otherwise an error code.
*/
int csp_usart_open_and_add_ccsds_interface(const csp_usart_conf_t *conf, const char * ifname, csp_iface_t ** return_iface);

/**
   Opens UART device and add EWC27 interface.
   ...
   @return #CSP_ERR_NONE on success, otherwise an error code.
*/
int csp_usart_open_and_add_ewc_interface(const csp_usart_conf_t *conf, const char * ifname, csp_iface_t ** return_iface);

/**
   Opens UART device and add MS200 interface.
   ...
   @return #CSP_ERR_NONE on success, otherwise an error code.
*/
int csp_usart_open_and_add_ms200_interface(const csp_usart_conf_t *conf, const char * ifname, csp_iface_t ** return_iface);

/**
   Opens UART device and add Slip interface.
   ...
   @return #CSP_ERR_NONE on success, otherwise an error code.
*/
int csp_usart_open_and_add_slip_interface(const csp_usart_conf_t *conf, const char * ifname, csp_iface_t ** return_iface);
#ifdef __cplusplus
}
#endif
#endif
