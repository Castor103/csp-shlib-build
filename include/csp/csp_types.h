...
/**
   Reserved Device for CSP services.
*/
typedef enum {
   CSP_CAN_DEVICE    = 0,                    // 0  = CAN
   CSP_CCSDS_DEVICE,                         // 1  = CCSDS
   CSP_EWC_DEVICE,                           // 3  = EWC27
   CSP_MS200_DEVICE,                         // 4  = MS200
   CSP_ZMQ_DEVICE    = 20                    // 20 = ZMQ
} csp_service_device_t;

/**
   Reserved ports for CSP services.
*/
typedef enum {
	CSP_CMP_PORT				= 0,   //!< CSP management, e.g. memory, routes, stats
	CSP_PING_PORT			   = 1,   //!< Ping - return ping
	CSP_PS_PORT				   = 2,   //!< Current process list
	CSP_MEMFREE_PORT			= 3,   //!< Free memory
	CSP_REBOOT_PORT			= 4,   //!< Reboot, see #CSP_REBOOT_MAGIC and #CSP_REBOOT_SHUTDOWN_MAGIC
	CSP_BUF_FREE_PORT		   = 5,   //!< Free CSP buffers
	CSP_UPTIME_PORT			= 6,   //!< Uptime
   CSP_RPARAM_PORT         = 7,
   CSP_TRANSACTION_PORT    = 8,
   CSP_BPX_HK_PORT         = 9,
   CSP_AX2150_GNDWDT_RESET = 9,
   CSP_BPX_CONFIG_GET_PORT = 18,
   CSP_BPX_CONFIG_SET_PORT = 19,
   CPS_BPX_HEATER_ON_PORT  = 20,
   CPS_BPX_HEATER_OFF_PORT = 21,
   CSP_TM_PORT             = 22,
   CSP_TC_PORT             = 27,
   CSP_GPIO_PORT           = 28,    // GPIO Test Port
} csp_service_port_t;
...
typedef enum __attribute__((__packed__)) {
    ...
    */
    CSP_PARAM_INT64 = 7,
    /**
       @deprecated - use #GS_CSP_PARAM_UINT8 and #GS_CSP_PARAM_F_SHOW_HEX.
    */
    CSP_PARAM_X8 = 8,
    /**
       @deprecated - use #GS_CSP_PARAM_UINT16 and #GS_CSP_PARAM_F_SHOW_HEX.
    */
    CSP_PARAM_X16 = 9,
    /**
       @deprecated - use #GS_CSP_PARAM_UINT32 and #GS_CSP_PARAM_F_SHOW_HEX.
    */
    CSP_PARAM_X32 = 10,
    /**
       @deprecated - use #GS_CSP_PARAM_UINT64 and #GS_CSP_PARAM_F_SHOW_HEX.
    */
    CSP_PARAM_X64 = 11,
    /**
       Double.
